    ...
    public List<Integer> call() throws Exception
      {
        ...
        Sorter leftSorter  = new Sorter(leftArrayToSort, executorService); // divide the array till the array size is 1
        Sorter rightSorter = new Sorter(rightArrayToSort, executorService); // divide the array till the array size is 1
